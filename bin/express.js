(function() {
  var Chain, GameState, Point, PointSet, decodeGameState, dimensions, renderFile, resolve, _ref;
  ...
  module.exports = function() {
    return function(req, res, next) {
      ...
      if (path.length > 70 && getHash.test(path)) {
        ...
        return renderFile(resolve("" + __dirname + "/../views/go-board.jade"), locals, function(err, svg) {
          if (err != null) {
        ...
        return res.sendfile(resolve("" + __dirname + "/../browser" + path));
      } else {
        return next();
      }
    };
